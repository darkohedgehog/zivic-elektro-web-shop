  ...
  return (
    <div
      className={cn(
        ...
        {
          'h-8 md:h-10 bg-brand-light shadow-counter rounded-3xl':
    ...
    >
      <button
        ...
        className={cn(
          ...
          {
            'w-8 md:w-12 h-8 rounded-2xl text-heading ms-1 hover:bg-fill-four':
              variant === 'mercury' || variant === 'cardv2',
      ...
      <button
        ...
        className={cn(
          ...
          {
            'w-8 md:w-12 h-8 rounded-2xl text-heading hover:bg-fill-four me-1':
              variant === 'mercury' || variant === 'cardv2',
